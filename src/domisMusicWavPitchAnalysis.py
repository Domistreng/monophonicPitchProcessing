...
userId = 'Temp'
originalFileLoc = "testAudioVoice.wav"
...
class PitchAnalyzer:
    ...
    def graphPitches(self, fileLoc):
        ...
        self.getPitchAtTime(specTimeLoc, fileName = ("plotPartial" + userId + ".png"))
        self.createWavGraph(fileLoc = ("plotFull" + userId + ".png"))
...
thisAnalyzer.graphPitches("pitchesPlotFull" + userId + ".png")


# totalAttempts = int(1/dist)
# avgFreqs = []
...
#     try:
#         # print("Attempting trial: #", i + 1, "/", totalAttempts)
#         avgFreqs.append(thisAnalyzer.getPitchAtTime(0.5 + (i * dist),dist))
#         functioningIndexs.append(i)
#     except Exception as err:
#         # print(err)
#         pass

# i = functioningIndexs[random.randint(0, len(functioningIndexs) - 1)]
# thisAnalyzer.getPitchAtTime(0.5 + (i * dist),dist, fileName = "appPlotShort.png")

    
# print("Median Freq: ", statistics.median(avgFreqs))

# thisAnalyzer.createWavGraph("appPlotFull.png")
